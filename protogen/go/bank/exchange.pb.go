...
type SomeExchangeMessage struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *SomeExchangeMessage) Reset() {
	*x = SomeExchangeMessage{}
	if protoimpl.UnsafeEnabled {
...
func (x *SomeExchangeMessage) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SomeExchangeMessage) ProtoMessage() {}

func (x *SomeExchangeMessage) ProtoReflect() protoreflect.Message {
	mi := &file_proto_bank_type_exchange_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SomeExchangeMessage.ProtoReflect.Descriptor instead.
func (*SomeExchangeMessage) Descriptor() ([]byte, []int) {
	return file_proto_bank_type_exchange_proto_rawDescGZIP(), []int{2}
}

func (x *SomeExchangeMessage) GetFullname() string {
	if x != nil {
		return x.Fullname
	}
	return ""
...
var file_proto_bank_type_exchange_proto_rawDesc = []byte{
	...
	0x69, 0x6d, 0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x22, 0x31, 0x0a, 0x13, 0x53, 0x6f, 0x6d, 0x65,
	...
	0x09, 0x52, 0x08, 0x66, 0x75, 0x6c, 0x6c, 0x6e, 0x61, 0x6d, 0x65, 0x42, 0x38, 0x5a, 0x36, 0x67,
...
var file_proto_bank_type_exchange_proto_goTypes = []interface{}{
	...
	(*SomeExchangeMessage)(nil),  // 2: bank.SomeExchangeMessage
}
...
func file_proto_bank_type_exchange_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_proto_bank_type_exchange_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*SomeExchangeMessage); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
